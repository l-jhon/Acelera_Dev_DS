...
# Instânciando modelo PCA
pca = PCA(n_components=2)



projected = pca.fit_transform(fifa - fifa.mean())
...
# Verificando a redução da dimensionalidade

#print(f'Dimensão Original: {fifa.shape} , Dimensão Projetada pela PCA: {projected.shape}')
